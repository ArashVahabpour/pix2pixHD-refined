...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--output_nc1', type=int, default=2, help='# of output image channels')
        self.parser.add_argument('--output_nc2', type=int, default=2, help='# of output image channels')
        ...
        self.parser.add_argument('--no_context', action='store_true', help='if specified, do *not* add context as input')
